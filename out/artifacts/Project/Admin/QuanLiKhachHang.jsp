								...
								<div class="modal-body">
									<div class="container">
										<form class="form-horizontal"
											action="<%=request.getContextPath()%>/KhachHangController"
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													...
													<p id="error_matkhau" style="color: red;"></p>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-sm-4" for="pwd">Nhập
													lại mật khẩu:</label>
												<div class="col-sm-4">
													<input type="password" class="form-control" id="nhaplaimatkhau"
														placeholder="Nhập lại mật khẩu" name="nhaplaimatkhau">
													<p id="error_nhaplaimatkhau" style="color: red;"></p>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-sm-4" for="pwd">Giới
													tính:</label>
												<div class="col-sm-4">
													<label class="radio-inline"><input type="radio"
														name="gioitinh" id="gioitinh" checked="checked"
														value="Nam">Nam</label> <label class="radio-inline"><input
														type="radio" name="gioitinh" id="gioitinh" value="Nữ">Nữ</label>
