            ...
            <div class="col-sm-4 col-sm-offset-1" style="margin-left: 35%">
                <div class="login-form"><!--login form-->
                    ...
                    <form action="<%=Util.fullPath("doLogin")%>" method="post">
                        ...
                        <button type="submit" class="btn btn-default" style="width: 70%;margin-left: 15%" ><i class="fa fa-key"></i>  Login</button>
                        <button type="button" class="btn btn-default" style="background: #4267b2 ;width: 70%;margin-left: 15%"><span class="UserModalstyle"><i class="fa fa-facebook"></i></span>  Login with Facebook</button>
                        <button type="button" class="btn btn-default" style="background: rgb(223 74 50);width: 70%;margin-left: 15%"><span class="UserModalstyle"><i class="fa fa-google-plus-square"></i></span>  Login with Google</button>
                    </form>
                </div><!--/login form-->
            </div>
        </div>
