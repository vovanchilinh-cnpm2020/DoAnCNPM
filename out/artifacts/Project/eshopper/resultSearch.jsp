        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <%
                        ResultSet search =(ResultSet) request.getAttribute("search");
                        while(search.next()){
                    %>
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="width:165px; height: 200px" src="<%= Util.fullPath(search.getString(4))%>"/>
                                    <h2><%=search.getDouble(3)%>$</h2>
                                    <p style="color: black"><%=search.getString(2)%></p>
                                    <a href="<%=Util.fullPath("LTLproduct?id="+search.getString(1)+"&type="+search.getInt(5))%>" class="btn btn-default add-to-cart"><i
                                            class="fa fa-shopping-cart"></i>Select</a>
                                    <a href="<%=Util.fullPath("AddCart?id="+search.getInt(1))%>" class="btn btn-default add-to-cart"><i
