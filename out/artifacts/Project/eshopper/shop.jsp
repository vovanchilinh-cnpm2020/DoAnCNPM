...
<%@ page import="vn.com.controller.LTLproduct" %>
<!DOCTYPE html>
<html lang="en">
<head>
...
<%--                    </div><!--/price-range-->--%>
            ...
            <div class="col-sm-9 padding-right">
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="width:165px; height: 200px" src="<%= Util.fullPath(pd.getString(4))%>"/>
                                    <h2><%=pd.getDouble(3)%>$</h2>
                                    <p style="color: black"><%=pd.getString(2)%></p>
                                    <a href="<%=Util.fullPath("LTLproduct?id="+pd.getString(1)+"&type="+pd.getInt(5))%>" class="btn btn-default add-to-cart"><i
                                            class="fa fa-shopping-cart"></i>Select</a>
                                    <a href="<%=Util.fullPath("AddCart?id="+pd.getInt(1))%>" class="btn btn-default add-to-cart"><i
                ...
                <ul class="pagination">
                    ...
                    %>
                    <li class="<%=cur==i+1 ?"active":""%>"><a href="<%=Util.fullPath(path+"?"+request.getAttribute("q")+(i+1))%>"><%=(i+1)%></a></li>
                    <%
                        }
                    %>
                </ul>
