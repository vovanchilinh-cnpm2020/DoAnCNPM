        ...
        <div class="row">
            <div class="col-sm-4" style="margin-left: 35%">
                <div class="signup-form" style="margin-bottom: 50px;margin-top: 20px">
                    ...
                    %>
                    <h2>Update Infor!</h2>
                    <span><%=request.getAttribute("erorname")!=null ? request.getAttribute("erorname"):""%></span>
                    <form action="<%=Util.fullPath("UpdateInfor")%>" method="post">
                        <input type="email" placeholder="Email Address" name="mail" value="<%=request.getAttribute("email") != null ? request.getAttribute("email") : u.getEmail()%>"/>
                        <input type="text" placeholder="Number Phone" name="phone" value="<%=request.getAttribute("phone") != null ? request.getAttribute("phone") : u.getPhone()%>"/>
                        <input type="text" placeholder="Your address" name="address" value="<%=request.getAttribute("address") != null ? request.getAttribute("address") : u.getAddress()%>"/>
