    		...
    		<div class="row">
	    		<div class="col-sm-8">
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" action="<%=Util.fullPath("Contact")%>" method="post">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>LTL Bookstore Inc.</p>

							<p>HO CHI MINH City</p>
							<p>Mobile:0397665385</p>
							<p>Email:ltlbookstore10@gmail.com</p>
	    				</address>
