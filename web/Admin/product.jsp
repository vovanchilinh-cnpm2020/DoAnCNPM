            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><img src="<%=rs.getString(6)%>" alt="" style="width: 110px;height: 150px"></td>
                  <td><%= rs.getInt(3)%></td>
                  ...
                  <td><%= rs.getInt(9)%></td>
                  <td>
                    <a onclick="" href="<%=Util.fullPath("dellpro?id=")+rs.getInt(1)%>">  <i  style="color: red ; font-size: 20px; float: right; margin: 6px"class="fas fa-trash"></i></a>
                    <a href="<%=Util.fullPath("checkId?id="+rs.getInt(1))%>"> <i  style="color: dodgerblue ; font-size: 20px; float: right; margin: 6px"class="fas fa-pencil-alt"></i></a>
                  </td>
