        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="ProductType">DataTables</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <a href="<%= Util.fullPath("Admin/them_user.jsp")%>"> <i  style="color: dodgerblue ; font-size: 20px; float: right; margin: 6px"class="fas fa-plus"></i></a>
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                 <a onclick="" href="<%=Util.fullPath("Delete?uname=")+rs.getString(2)%>">  <i  style="color: red ; font-size: 20px; float: right; margin: 6px"class="fas fa-trash"></i></a>
                    <a href="<%=Util.fullPath("updateuser?uname="+rs.getString(2))%>"> <i  style="color: dodgerblue ; font-size: 20px; float: right; margin: 6px"class="fas fa-pencil-alt"></i></a>
                  </td>
